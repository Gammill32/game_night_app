...
# These are PostgreSQL VIEWS mapped to SQLAlchemy models.
# Exclude from autogenerate so Alembic doesn't emit CREATE TABLE for them.
# View DDL is managed separately via op.execute() in dedicated migrations.
VIEW_TABLES = {
    "games_index",
...
def include_object(object, name, type_, reflected, compare_to):
    if type_ == "table" and name in VIEW_TABLES:
        return False
    return True
