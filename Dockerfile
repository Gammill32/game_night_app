...
RUN echo "0 10 * * * cd /app && /app/scripts/run_with_env.sh /usr/local/bin/python3 app/scripts/run_check_reminders.py >> /app/logs/cron.log 2>&1" > /etc/cron.d/reminders-cron
